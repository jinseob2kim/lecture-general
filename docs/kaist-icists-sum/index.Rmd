...
.large[
> 일제강점기 희생당한 선조들에게 빚져(대일 청구권 자금) 나라를 일으키겠다는 일념으로 지은 포항제철

> 철강왕 박태준은 "실패하면 영일만에 빠져 죽자" 는 다짐으로 제철소를 세웠다
...
- 최선의 결과를 내야하는 의사, 최선의 결과를 원하는 환자

- But, 최악과 차악뿐인 선택지

- 선택과 그 진행, 결과가 담긴 데이터를 헛되게 쓰면 안된다. 
