...
jstable만의 기능으로 subgroup analysis가 있는데요, 같은 분석을 성별, 나이 등 서브그룹에 따라 수행하고 Interaction P value를 보여줍니다. 이 테이블과 forestplot 패키지를 이용하면 의학논문에서 흔히 이용되는 forestplot을 그릴 수 있습니다. 
...
이 subgroup analysis 기능은 중국연구자들이 많이 이용중이며, 블로그와 영상으로 많이 리뷰되었습니다. jstable 패키지 issue 내용의 80% 이상이 중국 의학연구자들로부터의 요청입니다.  
...
::: notes
저희 회사는 학생 인턴십을 활발히 운영중으로, 현재 통계학과 학생, 의대생, 의사 포함 7명이 인턴십을 수행 중입니다. 인턴십 과정을 통해 R패키지 업데이트에 기여하고 있으며, 기여가 큰 인턴은 크랜에 공동개발자로 추가하였습니다. 
::: 
...
::: notes
저희 회사는 주기적으로 R 교육을 수행하고 있으며, 저는 한국의 성균관대학교 바이오헬스규제과학과의 겸임교수를 맡아 "의학연구를 위한 R 데이터분석" 이라는 주제로 1년간 강의를 수행하였습니다. 한국의 공공의료빅데이터를 이용해 실습을 수행하였으며 모든 강의자료와 코드, 그리고 동영상 강의를 깃허브에 업로드하였습니다. 
::: 
...
::: notes
4월에는 Tokyo R 온라인 밋업에 참여해 현 발표내용과 비슷한 내용을 짧게 발표하였습니다. 
::: 
...
::: notes
발표 들어주셔서 감사드리고 내용을 간단히 정리하겠습니다. 의학연구용 R패키지와 Shiny app을 개발하였고 일본과 중국에서 많이 이용되고 있습니다.  한국에서 R&D 지원을 받아 고도화하였으며,  최신 오픈소스 관리기술을 적용하고 라이선스를 검증받았습니다. 인턴십과 커뮤니티를 통해 활발한 패키지 업데이트를 수행하였습니다. 있고 향후 일본의 R 유저 및 의학연구자들과 활발히 교류하고 싶습니다. 
:::
