...
다음은 성과계획서 부분입니다.
먼저 목표 전체를 보여드린 후 하나하나 설명드리겠습니다.
...
다음은 사업추진 일정입니다.
올해 업그레이드된 분석기술로 연단위 계약을 확대해나가 매출 10억 100% 성장을 이루고, SaaS 구축을 통해 200% 성장까지 이루겠습니다.
사업기간 내 일본, 내년까지 미국에 진출할 것이며 일본 제약사 1개 이상과 계약을 체결할 것입니다.
2024년 말부터는 보고서서비스를 출시할 것이며, 완성된 임상시험 플랫폼으로 미국까지 진출하여 기하급수적 성장을 이루겠습니다.

사업비는 인건비 및 신규인력 노트북, 그리고 클라우드 비용을 기본으로, 특허, 해외 컨퍼런스 참가, 생성형AI/보안 기술컨설팅 위한 위한 용역으로 구성했습니다.
그동안 창업지원사업 및 R&D를 통해 자금을 확보했었으며, 계속 수행중인 챗봇과제, 새로 지원하는 R&D, 그리고 일본진출 위한 투자를 바탕으로 자금 확보하겠습니다.

이제부터 실현가능성을 현황과 실현방안으로 나눠 설명드리겠습니다.
먼저 분석기술입니다.
저희는 그동안 IITP, NIPA, 중기부 디딤돌과제 총 3건의 국가R&D의 책임연구자를 맡아 의학연구용 통계분석모듈을 30종 이상 개발하여 오픈소스SW로 공개했습니다.
이 분석모듈들을 조립해 24시간 내 맞춤형 분석웹을 만드는 기술을 확보했으며 흔한 분석기능들을 모아 5가지로 분류해 무료웹 openstat.ai를 글로벌 런칭했습니다.
복지부 가상환자 R&D의 공동연구책임자도 맡았는데, GPT 이용 병원 예진실 챗봇을 책임 개발하면서 생성형AI에 대한 노하우를 쌓았습니다.
분석서비스를 임상시험용으로 확대하기 위해 국내 최대 임상시험데이터관리SW회사인 CRSCube사와 협업하여 시범적으로 데이터 연계작업을 수행했고, 아까 말씀드렸듯이 대학병원, 그리고 바이오 기업들의 분석을 지원하고 있습니다.
계약한 기관의 연구자들을 위한 폐쇄 커뮤니티를 만들어 운영 중입니다.

다.

외부파트너를 소개드리겠습니다.
모교인 삼성의료원과 세브란스병원이 저희 가장 큰 고객으로, 연세/카카오 합작회사인 파이디지털헬스케어와 공동으로 R&D를 수행하면서 많은 헙업을 했고, SaaS 운영에 대한 노하우를 전수받을 예정입니다.
CRSCube와 긴밀하게 협업하고 있으며, 통합 플랫폼을 공동 개발하기로 협의하였고, 함께 NIPA R&D 과제를 지원한 상태입니다.
제약회사로는 신라젠이 저희의 가장 든든한 파트너이며, 연단위 계약을 수행하며 20건 이상의 임상시험분석 지원을 지원하였습니다.
그외 연단위 계약한 6개 병원 포함 대부분의 대학병원의 저희와 긴밀하게 협업중입니다.

다음은 기술경쟁력입니다.
저희 기술의 완성도 및 활용성을 말씀드리겠습니다.
차라투의 모든 분석기술은 오픈소스 R 패키지로 자체개발하여 공개했으며, 유저들의 실시간 피드백을 받아 버전업그레이드 150회, 누적 다운로드 15만회를 기록하였습니다.
특히 NIPA 컨설팅을 통해 최신 오픈소스 관리기술 적용 및 라이선스 검증을 완료하였습니다.
이 분석기술을 이용하여 맞춤형/범용 분석웹을 서비스하여 지금까지 200건 이상의 SCI논문으로 출판되었습니다.
특히 세브란스/삼성병원과 진행한 연구가 세계 3대저널인 NEJM/LANCET/JAMA에 출판되는 성과를 거두었습니다.
해당 기술들은 모두 공인검증기관의 성능평가를 받았으며, 2건의 국내 특허 등록 및, PCT 특허를 출원하였습니다.
분석기술에 관심있는 연구자들에게 지금까지 30회 이상의 교육을 진행하였습니다.

기존 임상시험SW 업체들은 데이터관리만 있고 분석기능이 없습니다.
할 수 없이 분석 때 쓰는 미국 SAS는 직접 코딩을 해야하는 부담감이 있는데다가 연간 억대의 막대한 라이선스 비용이 필요합니다.
차라투는 의학연구와 임상시험에 특화된 분석서비스를 SaaS 형태로 제공함으로서 설치 필요없이 웹에 접속해 클릭만으로 분석을 수행하고 결과를 보고서와 논문초안으로 다운받을 수 있어, 분석과 보고서 작성 시간을 절반이하로 단축할 수 있습니다.
또한 오픈소스로 개발된 분석모듈들은 연구자들과 외부 개발자들의 자발적인 참여를 통해 빠른 피드백을 받아 업데이트 할 수 있습니다.
최근 글로벌 제약사들이 함께 Pharmaverse라는 임상시험 데이터분석 오픈소스 프로젝트를 시작했는데, 다양한 임상시험 데이터를 다룰 수 있는 점이 장점이지만, 고급통계분석이 부족합니다.
본 사업을 통해 고급통계분석이 가능한 저희의 장점을 살리면서 phamarverse의 다양한 데이터 다루는 기능을 반영하여 임상시험 특화 서비스로 업데이트 하겠습니다.
